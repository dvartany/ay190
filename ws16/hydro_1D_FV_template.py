...
while(t < tend):
    ...
    if(i % 10 == 0):
        ...
        p2,=mpl.plot(hyd.x, hyd.vel, "k")
        p3,=mpl.plot(hyd.x, hyd.press, "b")
        timestring = "%5.3f" % (t)
        mpl.legend((p1,p2,p3),("Density","Velocity","Pressure"),loc=(0.,0.),
                   frameon=False)
        ax = mpl.gca()
    ...
    #if i == 200:
     #   mpl.savefig("t200.pdf")
    #if i == 500:
     #   mpl.savefig("t500.pdf")
    #if i == 950:
     #   mpl.savefig("t950.pdf")
