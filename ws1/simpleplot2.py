...
#define sin**2 cos array

def f(z):
    return np.sin(z)**2*np.cos(z)
    
g=[]
for z in np.linspace(0,1.8849555922E+01,1000):
    g.extend([f(z)])
...
p3, = pl.plot(x,g1,"g",linewidth=2.5)
...
# legend shifted slightly down and left
...
pl.legend( (p1,p2,p3), ("y1","y2","g1"), 
           loc=(0.3,0.01), frameon=False )
...
pl.savefig("/home/davidvartanyan/Desktop/simpleplot2.pdf")
